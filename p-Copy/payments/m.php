                ...
                <tbody>
                    ...
                    $result = mysqli_query($conn, "SELECT $paymentsNum.studentName, $WhatGroub.frNo, $WhatGroub.motherNo FROM $paymentsNum JOIN $WhatGroub ON $paymentsNum.studentName = $WhatGroub.studentName WHERE $paymentsNum.$month = 'لم يدفع' ");
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<a href="http://api.whatsapp.com/send?phone=972' . $frNo . '&text=' . $massagePaymentText . '&type=phone_number&app_absent=0" class="wa_btn"> ارسال الى الاب </a>';
                            echo "</button>";
                            echo "<button class='bt'>";
                            // Replace the variable $massagePayments with the actual value $massagePaymentText
                            echo '<a href="http://api.whatsapp.com/send?phone=972' . $motherNo . '&text=' . $massagePaymentText . '&type=phone_number&app_absent=0" class="wa_btn">ارسال الى الام </a>';
                            echo "</button>";
                            echo "</td>";
                            echo "</tr>";
                        }
